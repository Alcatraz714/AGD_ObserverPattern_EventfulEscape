...
public class LightSwitchView : MonoBehaviour, IInteractable
{
    ...
    private void OnEnable()  
    {
        ...
        EventService.Instance.OnLightsOffByGhostEvent.AddListener(onLightTurnedOffByGhosts);
    }

    private void OnDisable() 
    {
        EventService.Instance.OnLightSwitchToggled.RemoveListener(onLightSwitch);
        EventService.Instance.OnLightsOffByGhostEvent.RemoveListener(onLightTurnedOffByGhosts);
    }
    ...
    private void setLights(bool lightState)
    {
        foreach (Light lightSource in lightsources)
        {
    ...
    private void onLightTurnedOffByGhosts()
    {
        setLights(false);
        GameService.Instance.GetSoundView().PlaySoundEffects(SoundType.SwitchSound);
